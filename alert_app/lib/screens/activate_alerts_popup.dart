...
class ActivateAlertsPopup extends StatefulWidget {
  const ActivateAlertsPopup({super.key});

  @override
  State<ActivateAlertsPopup> createState() => _ActivateAlertsPopupState();
}

class _ActivateAlertsPopupState extends State<ActivateAlertsPopup> {
  ...
  Future<void> _requestNotificationListener() async {
    // This would typically open notification access settings
